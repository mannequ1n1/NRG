module global_data
    ...
    character(len=100)  ,parameter  :: problem_controls_data_file_name           = trim(task_setup_folder) // trim(fold_sep) // 'problem_controls.inf'
    ...
    real(dp)	,parameter	:: r_gase_J		= 8.31446261815324_dp           ! [J/(K * mol)]
    real(dp)	,parameter	:: r_gase_cal	= 1.98720425864083_dp           ! [cal/(K * mol)]
